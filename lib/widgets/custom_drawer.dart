              ...
              children: [
                ...
                ValueListenableBuilder<ThemeMode>(
                  ...
                  builder: (context, mode, _) {
                    final bool isDarkEffective = mode == ThemeMode.dark ||
                        (mode == ThemeMode.system && Theme.of(context).brightness == Brightness.dark);
                    return SwitchListTile(
                      secondary: Icon(
                        isDarkEffective ? Icons.dark_mode_outlined : Icons.light_mode_outlined,
                      ...
                      title: Text(
                        isDarkEffective ? 'Dark Theme' : 'Light Theme',
                      ...
                      onChanged: (bool newValue) {
                        ThemeService.setThemeMode(newValue ? ThemeMode.dark : ThemeMode.light);
                      },
                    );
                  },
                ),
